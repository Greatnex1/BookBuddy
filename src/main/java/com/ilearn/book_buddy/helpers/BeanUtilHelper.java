...
public class BeanUtilHelper extends BeanUtilsBean {
     ...
     * is not copied to the destination. This is useful whenever there is a dto required to accept
     * multiple fields without validation on all the fields, while having some fields
